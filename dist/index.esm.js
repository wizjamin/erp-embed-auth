...
var EmbedAuthContext = createContext({});
...
var EmbedAuthProvider = function (_a) {
    ...
    var _c = useState('unknown'), authState = _c[0], setAuthState = _c[1];
    var _onRedirect = useRef();
    var _authState = useRef(authState);
    var _commINIT = useRef(false);
    var _onMessageListeners = useRef({});
    ...
    var _onMessage = useRef(function (e) {
        var _a;
...
var useEmbedAuth = function () {
    var ctx = useContext(EmbedAuthContext);
    if (!ctx)
        throw new Error('EmbedAuth context not found');
    return ctx;
};

export { EmbedAuthProvider, useEmbedAuth };
